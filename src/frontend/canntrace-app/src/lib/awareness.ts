...
export const SECTORES: Record<SectorKey, SectorDef> = {
  ...
  agua: {
    ...
    fechaCol: 'fecha', createdCol: 'creado_en',
    color: '#3fb074', icon: Droplet, path: '/registros', refField: 'responsable',
  },
  personal: {
  ...
  cosecha: {
    ...
    fechaCol: 'fecha', createdCol: 'creado_en',
    color: '#E3B94A', icon: Scissors, path: '/registros', refField: 'codigo_lote',
  },
  mantenimiento: {
  ...
  operaciones: {
    ...
    color: '#6bcf8e', icon: Activity, path: '/operacion', refField: 'tipo_operacion',
  },
  alertas: {
