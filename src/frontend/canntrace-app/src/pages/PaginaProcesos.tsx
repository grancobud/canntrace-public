...
export default function PaginaProcesos() {
  ...
  return (
    <div className="flex-1 flex flex-col overflow-hidden bg-[#0a0f0d] text-[#d3d8d4] font-sans">
      {/* TopBar */}
      <div className="sticky top-0 z-40 bg-[#0a0f0d]/95 backdrop-blur-[2px] border-b border-[#1a2620]">
        <div className="flex items-center gap-2 sm:gap-4 px-3 sm:px-6 py-3">
          <Workflow className="w-4 h-4 text-[#3fb074] flex-shrink-0" strokeWidth={1.8} />
          <div className="min-w-0">
            <h1 className="font-display font-bold tracking-tight text-[15px] sm:text-[17px] text-[#e8ece9]">Mapa de Procesos</h1>
            <div className="mt-0.5 text-[10.5px] sm:text-[11px] text-[#5a6560]">
              Flujo seed-to-sale
              <span className="hidden sm:inline"><span className="text-[#343c37] mx-1">│</span>BPMN 2.0 · GAMP5 Cat.5</span>
            </div>
          </div>
          <div className="flex-1" />
          <button
            onClick={reset}
            className="flex items-center gap-1.5 px-2.5 py-1.5 bg-[#0e1411] hover:bg-[#111916] border border-[#1a2620] hover:border-[#243429] text-[#a7b1ab] rounded-lg text-[11px] transition-colors"
          >
          ...
          <button
            onClick={descargar}
            className="flex items-center gap-1.5 px-2.5 py-1.5 bg-[#3fb074]/15 hover:bg-[#3fb074]/25 border border-[#2a5138] text-[#8fe0a8] rounded-lg text-[11px] transition-colors"
          >
      ...
      <div className="flex-1 relative overflow-hidden">
        {cargando && (
          <div className="absolute inset-0 z-10 flex items-center justify-center bg-[#0a0f0d]">
            <Loader2 className="w-8 h-8 animate-spin text-[#3fb074]" />
          </div>
        )}
        <div
          ref={containerRef}
