        ...
        <div className="sticky top-0 z-40 bg-[#0a0f0d]/95 backdrop-blur-[2px] border-b border-[#1a2620]">
          <div className="flex items-center gap-2 sm:gap-4 px-3 sm:px-6 py-3">
            ...
            <div className="min-w-0">
              <h1 className="font-display font-bold tracking-tight text-[15px] sm:text-[17px] text-[#e8ece9]">Documentacion GAMP5</h1>
              <div className="mt-0.5 text-[10.5px] sm:text-[11px] text-[#5a6560]">
                ...
                <span className="hidden sm:inline"><span className="text-[#343c37] mx-1">│</span> 21 CFR Part 11 · EU-GMP Annex 11 · ALCOA+</span>
              </div>
            </div>
            <div className="flex-1" />
            <span className="hidden sm:inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full border border-[#C49A2C]/30 bg-[#C49A2C]/10 text-[#E3B94A] text-[10.5px] uppercase tracking-widest font-medium">
              <span className="w-1.5 h-1.5 rounded-full bg-[#E3B94A]" />CAT5
            </span>
          </div>
        </div>
        ...
        <div className="px-3 sm:px-6 py-4 sm:py-5 pb-20 space-y-4 sm:space-y-5">
          ...
          <div className="rounded-xl bg-[#0e1411] border border-[#1a2620] p-5">
            <div className="flex items-start gap-3 mb-4">
              <Shield className="w-5 h-5 text-[#3fb074] flex-shrink-0 mt-0.5" />
              <div>
                <p className="text-[13px] font-display font-semibold text-[#e8ece9]">CannTrace implementa GAMP5 Categoria 5 — Resumen Ejecutivo</p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              {[
                ...
                <div key={title} className="rounded-lg bg-[#111916] border border-[#1a2620] p-3">
                  <p className="text-[11px] font-bold text-[#6bcf8e] mb-1.5">{title}</p>
                  <ul className="space-y-0.5">
                    {items.map(item => (
                      <li key={item} className="text-[10.5px] text-[#b2bab4]">• {item}</li>
                    ))}
                  </ul>
                </div>
              ))}
            ...
            <p className="text-[10.5px] text-[#454e48] mt-4 italic">
          ...
          >
            {Object.entries(documentos).map(([key, doc]) => (
              <motion.button
                ...
                className="rounded-xl bg-[#0e1411] border border-[#1a2620] hover:border-[#2a5138] p-5 text-left transition-colors group"
              >
                <div className="flex items-start gap-3">
                  <div className="w-11 h-11 bg-[#3fb074]/10 rounded-xl flex items-center justify-center flex-shrink-0 group-hover:bg-[#3fb074]/15 transition-colors">
                    <FileText className="w-5 h-5 text-[#3fb074]" />
                  </div>
                  <div className="flex-1 min-w-0">
                    <h3 className="font-display font-semibold text-[13px] text-[#e8ece9] mb-1">{doc.titulo}</h3>
                    <p className="text-[11px] text-[#5a6560] mb-2 leading-relaxed">{doc.desc}</p>
                    <div className="flex items-center gap-2 flex-wrap">
                      <span className="inline-flex items-center gap-1 text-[9.5px] font-medium text-[#6bcf8e] bg-[#3fb074]/10 border border-[#2a5138] px-2 py-0.5 rounded-full">
                        <BookOpen className="w-3 h-3" />
                        {doc.referencia}
                      </span>
                      <span className="inline-flex items-center gap-1 text-[9.5px] font-medium text-[#E3B94A] bg-[#C49A2C]/10 border border-[#5a4820] px-2 py-0.5 rounded-full">
    ...
    return (
      <div className="flex-1 overflow-y-auto bg-[#0a0f0d] text-[#d3d8d4] font-sans ct-page-scroll">
        <div className="flex-1 flex items-center justify-center py-20">
          <p className="text-[#5a6560]">El documento {docId} no existe.</p>
        </div>
      </div>
    )
  }
    ...
    <div className="flex-1 overflow-y-auto bg-[#0a0f0d] text-[#d3d8d4] font-sans ct-page-scroll">
      ...
      <div className="sticky top-0 z-40 bg-[#0a0f0d]/95 backdrop-blur-[2px] border-b border-[#1a2620]">
        <div className="flex items-center gap-2 sm:gap-4 px-3 sm:px-6 py-3">
          <ShieldCheck className="w-4 h-4 text-[#3fb074] flex-shrink-0" strokeWidth={1.8} />
          <div className="min-w-0">
            <h1 className="font-display font-bold tracking-tight text-[15px] sm:text-[17px] text-[#e8ece9]">{doc.titulo}</h1>
            <div className="mt-0.5 text-[10.5px] sm:text-[11px] text-[#5a6560]">
              {doc.referencia}
              <span className="hidden sm:inline"><span className="text-[#343c37] mx-1">│</span> {doc.desc}</span>
            </div>
          </div>
          <div className="flex-1" />
      ...
      <div className="px-3 sm:px-6 py-4 sm:py-5 pb-20 space-y-4 sm:space-y-5">
        ...
        <div className="rounded-xl bg-[#0e1411] border border-[#1a2620] p-5 space-y-5">
          {/* Header */}
          <div className="flex items-center gap-3">
            <span className="text-[10.5px] font-mono text-[#6bcf8e] bg-[#3fb074]/10 border border-[#2a5138] px-2.5 py-1 rounded-lg font-bold">{docId}</span>
            <span className="text-[#243429]">|</span>
            <span className="text-[11px] text-[#5a6560]">{doc.referencia}</span>
            <div className="ml-auto flex items-center gap-1.5">
              <CheckCircle2 className="w-4 h-4 text-[#3fb074]" />
              <span className="text-[11px] text-[#6bcf8e] font-medium">Implementado</span>
            </div>
          </div>

          {/* Que es */}
          <div className="p-4 bg-[#111916] rounded-xl border border-[#1a2620]">
            <p className="text-[10px] uppercase tracking-[0.14em] text-[#5a6560] font-medium mb-2">Que es este documento</p>
            <p className="text-[12.5px] text-[#d3d8d4] leading-relaxed">{doc.queEs}</p>
          </div>

          {/* Que hace el software */}
          <div className="p-4 bg-[#3fb074]/8 rounded-xl border border-[#2a5138]">
            <div className="flex items-center gap-2 mb-3">
              <Monitor className="w-4 h-4 text-[#3fb074]" />
              <p className="text-[10px] uppercase tracking-[0.14em] text-[#6bcf8e] font-medium">Que hace CannTrace para cumplirlo</p>
            </div>
            <ul className="space-y-2">
              {doc.queHaceElSoftware.map((item, i) => (
                <li key={i} className="flex items-start gap-2">
                  <CheckCircle2 className="w-4 h-4 text-[#3fb074] flex-shrink-0 mt-0.5" />
                  <span className="text-[12.5px] text-[#b2bab4] leading-relaxed">{item}</span>
                </li>
              ))}
            </ul>
          </div>
          ...
          <div className="grid grid-cols-3 gap-3">
            <div className="p-3 bg-[#111916] rounded-xl border border-[#1a2620] text-center">
              <Database className="w-5 h-5 text-[#5a6560] mx-auto mb-1" />
              <p className="text-[11px] font-medium text-[#d3d8d4]">23 tablas</p>
              <p className="text-[10px] text-[#5a6560]">con RLS activo</p>
            </div>
            <div className="p-3 bg-[#111916] rounded-xl border border-[#1a2620] text-center">
              <Lock className="w-5 h-5 text-[#5a6560] mx-auto mb-1" />
              <p className="text-[11px] font-medium text-[#d3d8d4]">4 roles</p>
              <p className="text-[10px] text-[#5a6560]">con permisos</p>
            </div>
            <div className="p-3 bg-[#111916] rounded-xl border border-[#1a2620] text-center">
              <Shield className="w-5 h-5 text-[#5a6560] mx-auto mb-1" />
              <p className="text-[11px] font-medium text-[#d3d8d4]">SHA-256</p>
              <p className="text-[10px] text-[#5a6560]">audit trail</p>
            </div>
          </div>
        </div>
      </div>
